...
bluePlayer = BluePlayer('Sprites/Players/BluePlayerRight.png', 0, 0, False,
                        1)  # declaring bluePlayer as a BluePlayer iteration
...
while True:  # running a game loop
    ...
    for item in blueFlagGrab:  # iterating through the list of players touching it
        if item == redPlayer:  # if the player is the red player
            ...
            redPlayer = RedPlayer('Sprites/Players/RedPlayerBlueFlag.png', redPlayer.getRectX(), redPlayer.getRectY(), True, redPlayer.getDirection())  # redeclaring the redPlayer with a new sprite of them with the flag, and setting the hasFlag value to true
    ...
    for item in redFlagGrab:  # iterating through the list of players touching it
        if item == bluePlayer:  # if the player is the blue player
            ...
            bluePlayer = BluePlayer('Sprites/Players/BluePlayerRedFlag.png', bluePlayer.getRectX(), bluePlayer.getRectY(), True, bluePlayer.getDirection())  # redeclaring the bluePlayer with a new sprite of them with the flag, and setting the hasFlag value to true
    ...
    players = pygame.sprite.Group(
        [bluePlayer, redPlayer])  # redeclaring the group of players to make sure they are up to date
